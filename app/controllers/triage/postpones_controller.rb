...
module Triage
  class PostponesController < ApplicationController
    ...
    def create
      @bullet.postpone!(bucket: Current.user.monthlylogs.covering(Date.current).take.bucket, pops_on: nil)
      @bullet.reload

      respond_to do |format|
        format.turbo_stream
        format.html { redirect_to triage_path, notice: 'Added to backlog' }
      end
