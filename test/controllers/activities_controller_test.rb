...
class ActivitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'index shows activities newest first' do
    ...
    BulletActivity.record(user: @user, bullet: a, action: BulletActivity::EDITED)
    BulletActivity.record(user: @user, bullet: b, action: BulletActivity::ARCHIVED)
  ...
  test 'index filters by bullet_id' do
    ...
    BulletActivity.record(user: @user, bullet: keep, action: BulletActivity::COMPLETED)
    BulletActivity.record(user: @user, bullet: other, action: BulletActivity::EDITED)
