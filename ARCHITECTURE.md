...
| `composer.css` | `composer`, `composer--rail`, `composer--text-form-wrap`, `composer--chrome`, `composer--multiline`, … | Fixed chat composer dock |
