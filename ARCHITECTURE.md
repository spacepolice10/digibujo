...
| `daylog.css` | `daylog--chat`, `daylog--shell`, `daylog--scroller`, `daylog--older-trigger`, `daylog--date-picker`, `daylog--mood`, `daylog--photo-card`, `daylog--photo-toolbar`, `daylog--pending-inbox`, … | Chat shell and day-level artifacts on the daylog |
