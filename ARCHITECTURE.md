...
**Monthly spread:** dated and unplanned sections render the same composer partial with their own bucket/date context and variant allowlist. Lazy monthlylog frames keep each composer local to its section.
